  ...
  return (
    <Box id="exercises" sx={{ mt: { lg: '110 px' } }} mt="50px" p="20px">
      ...
      <Stack mt="100px" alignItems="center"> 
        {exercises.length > 9 && ( //if more than 9 items in a page then paginate
          ...
          page= {currentPage} 
          onChange= {paginate} //this paginate component immediately passes onChange = { (e)=> paginate(e,value)} on the backend . thisis done by material ui
          size="large"/>
        )}
